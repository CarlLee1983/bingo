...
- [x] **SESS-01**: Host can create a new game session and add multiple players before the game starts
- [x] **SESS-02**: Host can reset the current session and start a fresh round without reloading the page
- [x] **SESS-03**: Game state can be saved and restored locally in the browser

### Cards

- [x] **CARD-01**: Each player receives a unique randomized 5x5 American bingo card
- [x] **CARD-02**: Generated cards follow B-I-N-G-O number ranges and use a free center space
- [x] **CARD-03**: Card generation avoids duplicate numbers within the same card

### Calling

- [x] **CALL-01**: Host can draw bingo numbers randomly without replacement from 1 to 75
- [x] **CALL-02**: Called numbers are shown in order with the full call history visible
- [x] **CALL-03**: The game prevents duplicate calls and clearly marks already-called numbers

### Winning

- [x] **WIN-01**: Game automatically detects standard winning patterns such as row, column, and diagonal
- [x] **WIN-02**: The system can validate a claimed bingo and identify the winning player
- [x] **WIN-03**: The UI clearly indicates when a player has won and which pattern completed

### Extensibility

- [x] **RULE-01**: Winning patterns are defined in data rather than hardcoded in the UI
- [x] **RULE-02**: The rules engine can support future variants without restructuring the session flow

### Platform

- [x] **PLAT-01**: The app can be built and deployed as static assets on GitHub Pages without a backend
